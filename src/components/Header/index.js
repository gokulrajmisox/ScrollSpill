...
const toggle = () =>{
  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between sticky top-0 z-50 bg-light/70 dark:bg-dark/70 backdrop-blur-xl border-b border-dark/10 dark:border-light/10 animate-fade-in">
        <Logo />
